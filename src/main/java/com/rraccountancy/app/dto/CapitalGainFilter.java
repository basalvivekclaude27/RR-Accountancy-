...
/** Query-string-bound filter state for the CGT Cases Overview list. */
public class CapitalGainFilter {
    ...
    public boolean hasAssetType() { return assetType != null && !assetType.isBlank(); }
