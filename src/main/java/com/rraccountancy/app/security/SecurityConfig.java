    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/service-charge/**").hasRole("ADMIN")
                .requestMatchers("/business-startup/**").hasRole("ADMIN")
                .requestMatchers("/company-formation/**").hasRole("ADMIN")
                .requestMatchers("/business-plans/**").hasRole("ADMIN")
                .requestMatchers("/personal-income-tax/**").hasRole("ADMIN")
                .requestMatchers("/business-income-tax/**").hasRole("ADMIN")
                .requestMatchers("/corporation-tax/**").hasRole("ADMIN")
                .requestMatchers("/value-added-tax/**").hasRole("ADMIN")
                .requestMatchers("/capital-gain-tax/**").hasRole("ADMIN")
                .requestMatchers("/inheritance-tax/**").hasRole("ADMIN")
