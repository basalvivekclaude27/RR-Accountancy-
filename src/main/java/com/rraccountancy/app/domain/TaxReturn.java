...
public class TaxReturn {
    ...
    /** Positive = refund due to client, negative = tax payable, null = not yet known. */
    ...
    public String getRefundLabel() {
        ...
        String formatted = "£" + String.format(Locale.UK, "%,.0f", refundAmount.abs());
        return refundAmount.signum() < 0 ? "(" + formatted + ")" : "+" + formatted;
    }
